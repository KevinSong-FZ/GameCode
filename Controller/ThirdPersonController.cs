...
public class ThirdPersonController : MonoBehaviour
{
    ...
    //https://blog.csdn.net/qq_38693757/article/details/80296315
    ...
    private float minRoll = -40f * Mathf.PI * 2 / 360;
    //纵向旋转速度  
    ...
    void Rotate()
    {
        float w = Input.GetAxis("Horizontal") * rotSpeed;
        rot -= w;
    }
    ...
    void Roll()
    {
        float w = Input.GetAxis("Vertical") * rollSpeed * 0.5f;
